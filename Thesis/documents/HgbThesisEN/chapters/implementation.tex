...
\item The Camera Texture returned by the api is inside of the GPU memory. For inpainting and the quality evaluation, this needs to be sent to the CPU which takes up additional latency.\\
\end{itemize}
